<?php
  ...
  define("MESSAGE_SHOW_UPCOMING_BUILDINGS", 15);
  define("MESSAGE_SHOW_CURRENT_BUILDINGS", 16);
  define("MESSAGE_SHOW_UPCOMING_AUCTIONS", 17);
  define("MESSAGE_SHOW_BUILDING_DISCARD", 18);
  define("MESSAGE_SHOW_UPCOMING_EVENTS", 19);
  define("MESSAGE_SHOW_EVENTS_DISCARD", 20);
  define("MESSAGE_HIDE_UPCOMING_BUILDINGS", 25);
  define("MESSAGE_HIDE_CURRENT_BUILDINGS", 26);
  define("MESSAGE_HIDE_UPCOMING_AUCTIONS", 27);
  define("MESSAGE_HIDE_BUILDING_DISCARD", 28);
  define("MESSAGE_HIDE_UPCOMING_EVENTS", 29);
  define("MESSAGE_HIDE_EVENTS_DISCARD", 30);
