...
$stats_type = array(
    ...
    "player" => array(
        ...
        "bonus_vp_7" => array("id"=> 24,
                    "name" => totranslate("Bonus VP for # Debt paid off"), "type" => "int" ),
        
        "buildings" => array("id"=> 25,
                    "name" => totranslate("# Buildings"), "type" => "int" ),
        "residential" => array("id"=> 26,
                    "name" => totranslate("# Residential buildings"), "type" => "int" ),
        "industrial" => array("id"=> 27,
                    "name" => totranslate("# Industrial buildings"), "type" => "int" ),
        "commercial" => array("id"=> 28,
                    "name" => totranslate("# Commercial buildings"), "type" => "int" ),
        "special" => array("id"=> 29,
                    "name" => totranslate("# Special buildings"), "type" => "int" ),
        "bids" => array("id"=> 30,
                    "name" => totranslate("# bids made"), "type" => "int" ),
                    
        "auctions_won" => array("id"=> 31,
                    "name" => totranslate("# Auctions won"), "type" => "int" ),
        "win_auction_1" => array("id"=> 32,
                    "name" => totranslate("# win Auction 1"), "type" => "int" ),
        "win_auction_2" => array("id"=> 33,
                    "name" => totranslate("# win Auction 2"), "type" => "int" ),
        "win_auction_3" => array("id"=> 34,
                    "name" => totranslate("# win Auction 3"), "type" => "int" ),
        "win_auction_4" => array("id"=> 35,
                    "name" => totranslate("# win Auction 4"), "type" => "int" ),
        "spent_on_auctions" => array("id"=> 36,
                    "name" => totranslate("Amount spent on auctions"), "type" => "int" ),
        "times_outbid" => array("id"=> 37,
                    "name" => totranslate("# Times outbid"), "type" => "int" ),
        "outbids" => array("id"=> 38,
                    "name" => totranslate("# Times outbid others "), "type" => "int" ),
        "loans" => array("id"=> 39,
                    "name" => totranslate("# Loans taken"), "type" => "int" ),
        "loans_paid_end" => array("id"=> 40,
                    "name" => totranslate("# Loans paid at end of game"), "type" => "int" ),
    )
